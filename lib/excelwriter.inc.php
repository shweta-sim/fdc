			...
			$header = <<<EOH
				...
				<!--[if gte mso 9]><xml>
				 <o:DocumentProperties>
				  <o:LastAuthor>Navraj</o:LastAuthor>
				  <o:LastSaved>2007-12-12T07:46:23Z</o:LastSaved>
...
EOH;
		...
		*/
		...
		function writeHeading($heading,$line_arr)
		{
			if($this->state!="OPENED")
			{
				$this->error="Error : Please open the file.";
			...
			fwrite($this->fp,"<tr><th class=xl25 colspan=".count($line_arr)."><strong><center>$heading</center></strong></th></tr>");
		}
		
		function writeHeadingLine($heading,$line_arr)
		{
			if($this->state!="OPENED")
			{
				$this->error="Error : Please open the file.";
			...
			fwrite($this->fp,"<tr>");
			foreach($line_arr as $col)
				fwrite($this->fp,"<th class=xl25 width=64 ><strong><center>$col</center></strong></th>");
			fwrite($this->fp,"</tr>");
		}
