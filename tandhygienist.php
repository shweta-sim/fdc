...
<html lang="en">
    <head>
        ...
        <title>Family Dental Care | Tandhygienist </title>
    ...
    <body>
        ...
        <section class="page-title">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Tandhygienist<span>Tandhygienist</span></h1>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="left-link fontGayathri mb10">
                                <ul>                                                                        
                                    ...
                                    <a href="tandhygienist.php">
                                        <li class="left-link-active">Tandhygienist 
                                            <span>
                                                <img src="imgs/behandlingar/icon_tandhygienist_white.png" alt="">
                                            </span>
                                        </li>
                                    </a>
                        ...
                        <div class="col-md-6 offset-md-1 col-lg-6 offset-lg-1 col-xl-7 offset-xl-1 order-lg-last mb6-md">
                            <p class="mb6">Målet för våra tandhygienister är att du ska få en friskare mun, förebygga kariesangrepp och parodontit (tandlossning) med hjälp av vår behandling samt ge noggrann information om hur du kan ta hand om din munhälsa på bästa sätt. Under en behandling rengör tandhygienisten noggrant din mun genom att ta bort tandsten och eventuella missfärgningar. De mäter även dina tandköttsfickor för att se om du har några fördjupade fickor. Vid eventuella djupa fickor kan återkommande besök behövas. Efter besöket känner du dig ren och fräsch i munnen.</p>
                            <h5 class="text-blue mb1">Vad är parodontit (tandlossning)?</h5>
                            <p class="mb3">Tandlossning är en relativt vanlig mun sjukdom som går att behandla med mycket goda resultat. Tandlossning är oftast en långsam process som är aktiv då tandköttet är inflammerat. Inflammationens grad och tandlossningens utveckling påverkas av närvaron av specifika bakterier i munhålan och individens svar på detta. Faktorer som påverkar är bland annat arv, rökning, sjukdomar och stress.</p>
                            <p class="mb3">För att förebygga detta gäller regelbundna tandläkarbesök och hygienist behandlingar där vi kontrollerar och förhindrar fortsatt progression av tandlossningen. Det är även viktigt att du som patient upprätthåller en mycket god munhygien. I sällsynta fall kan vi även erbjuda kirurgiska behandlingar för att få din tandlossning att läka på bästa sätt.</p>
                            <p class="mb3 behand">För att boka ditt tandhygienistbesök, <a href="bokningsforfragan.php">klicka här</a>.</p>  
                        </div>
                    </div>
                </div>
            </section>  
