...
<html lang="en">
    <head>
        ...
        <title>Family Dental Care | Kronor och broar </title>
    ...
    <body>
        ...
        <section class="page-title">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Kronor och broar <span>Kronor och broar </span></h1>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="left-link fontGayathri mb10">
                                <ul>                                                                        
                                    ...
                                    <a href="kronorochbroar.php">
                                        <li class="left-link-active">Kronor och broar 
                                            <span>
                                                <img src="imgs/behandlingar/icon_kronor_och_broar_white.png" alt="">
                                            </span>
                                        </li>
                                    </a>
                        ...
                        <div class="col-md-6 offset-md-1 col-lg-6 offset-lg-1 col-xl-7 offset-xl-1 order-lg-last mb6-md">
                            <p class="mb6">Tänder som till hög grad blivit skadade på ett eller annat sätt går inte att hållbart reparera med hjälp av en vanlig plastfyllning. Vad som då krävs är en laboratorieframställd tandkrona individuellt anpassad efter din tand och ditt bett. Dessa nya tänder framställs vanligen i porslin.</p>
                            <h5 class="text-blue mb1">Vad är en laboratorieframställd tandkrona och hur går det till?</h5>
                            <p class="mb3">En tandkrona sitter som ett skal fastcementerad på din riktiga tand. Denna behandling är uppdelad i två besök. Under det första besöket preparerar tandläkaren din tand genom att slipa till den, därefter tar man avtryck och tillsammans väljer ni en färgnyans för vad som passar med dina resterande tänder. Avtrycket skickas till en tandtekniker som sedan framställer din porslinskrona.</p>
                            <p class="mb3">Under tiden då kronan framställs har du en temporär krona över den preparerade tanden.</p>
                            <p class="mb6">Efter cirka 2 veckor är kronan klar för att sättas fast på plats, vilket man gör med hjälp av ett cement. Man kollar då hur bettet funkar med den nya tanden och finjusterar vid behov.</p>
                            <h5 class="text-blue mb1">Porslins Bro</h5>
                            <p class="mb6">Om du blivit av med en eller fler tänder och tänderna bredvid har mycket lagningar så kan ett alternativ vara att framställa en bro med närliggande tänder som bro stöd. Denna behandling går till på samma sätt som för en tandkrona förutom att man preparerar fler tänder.</p>
                            <h5 class="text-blue mb1">Vårt material</h5>
                            <p class="mb3">Vi erbjuder och använder oss av material såsom Emax, Zirkonia och DenZir. Dessa material är mycket starka och är de hållbaraste helkeramiska material inom tandvården idag.</p>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="tandimplantat ba-slider">
                                <img src="imgs/behandlingar/kronorochbroar-after.png" alt="">
                                <div class="resize"> <img src="imgs/behandlingar/kronorochbroar-before.png" alt=""> </div>
