<header id="top">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 d-flex align-items-center">
          <ul>
            <li><i class="fas fa-phone-alt mr-2"></i><span class="text-bold">Vardagar: </span> 08.00 – 17.00</li>
            <li><span class="text-bold">Lunchstängt: </span> 12.00 – 13.00 (Mån-Fre)</li>
          </ul>
          <ul class="ml-auto">
  ...
  <!-- Nav start -->
  <nav class="navbar navbar-expand-lg static-top" id="navbar-fixed-on-scroll">
    <div class="container">
      <a class="navbar-brand" href="index.php">
        <img src="imgs/logo.png" alt="Family Dental Care" class="img-fluid">
      </a>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="kungsholmen.php">Kungsholmen</a>
              <a class="dropdown-item" href="specialistkliniken.php">Specialistkliniken</a>
              <a class="dropdown-item" href="degerfors.php">Degerfors</a>
            </div>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="fyllningar.php">Fyllningar</a>
