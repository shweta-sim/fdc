...
<html lang="en">
    <head>
        ...
        <title>Family Dental Care | Tandimplantat</title>
    ...
    <body>
        ...
        <section class="page-title">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Tandimplantat<span>Tandimplantat</span></h1>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="left-link fontGayathri mb10">
                                <ul>                                                                        
                                    ...
                                    <a href="tandimplantat.php">
                                        <li class="left-link-active">Tandimplantat 
                                            <span>
                                                <img src="imgs/behandlingar/icon_tandimplantat_white.png" alt="">
                                            </span>
                                        </li>
                                    </a>
                        ...
                        <div class="col-md-6 offset-md-1 col-lg-6 offset-lg-1 col-xl-7 offset-xl-1 order-lg-last mb6-md">
                            <p class="mb3">Avsaknaden av tänder kan få vem som helst att känna sig osäker och självmedveten. Kanske letar Du efter en lösning till tandluckorna och önskar återfå ditt vackra leende? 
                                Vi kan hjälpa Dig med detta!</p>
                            <p class="mb3">Att ha ett vackert leende och friska tänder ger dig inte bara känslan av att vara attraktiv och fräsch, det är dessutom viktigt för att klara av dagliga rutiner som att äta ett äpple, le, tala eller kyssas. Om Du har blivit av med en tand eller flera så kan det därmed leda till både psykologiska och funktionella besvär.</p>  
                            <p class="mb6">Med hjälp av ett tandimplantat kan man ersätta förlorade tänder på en mängd olika vis för att återfå en naturlig estetik och fullgod funktion. Implantat kan användas för att ersätta en tand, flera tänder, eller alla tänder.</p>
                            <div class="mb6 tandimplantat-video content-video">                                
                                <img src="imgs/behandlingar/icon-youtube.png" onclick="lightboxSecond_open();" alt=""/>
                            </div>
                            <h5 class="text-blue mb1">Varför förlorar man tänder?</h5>
                            <p class="mb6">Det finns flera olika anledningar till varför man saknar en tand. Det kan till exempel bero på en olycka, genetik, karies eller tandlossning.</p>
                            <h5 class="text-blue mb1">Vad är ett tandimplantat?</h5>
                            <p class="mb3">Ett tandimplantat kan i de flesta fall vara en långsiktig lösning. Det ersätter den förlorade tandroten och fungerar som fäste för en konstgjord tand.</p>
                            <p class="mb6">Genom att efterlikna naturen förankras implantatet i käkbenet precis som en vanlig rot och håller tanden på plats. Implantat består bland annat av en titan och titan-zirkoniumlegering som accepteras mycket väl av kroppen och titan binder bevisligen bra till 
                                mänskligt ben.</p>
                            <h5 class="text-blue mb1">Hur installerar man ett implantat?</h5>
                            <p class="mb3">Ett tandimplantat installeras kirurgiskt under vanlig lokalbedövning. När det sedan har läkt in i benet så används det som en rot på vilken man fäster den synliga tanden.</p>
                            <p class="mb3">Eftersom alla kirurgiska ingrepp innebär en potentiell risk så är det viktigt att göra en grundläggande undersökning och utredning för att sedan kunna ta ställning till om implantat är något för Dig.</p>
                            <p class="mb3 behand">Välkommen in på implantatkonsultation hos oss. <a href="bokningsforfragan.php">Boka din tid här</a></p>
                        </div>
                    </div>
                </div>
            </section>  
       ...
       <iframe width="800" height="480" src="https://www.youtube.com/embed/RABIU6bmzOs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
