    ...
    <div class="footer-top">
      <div class="row">
        <div class="col-md-9 footer-left">
          <div class="row">
            <div class="col-md-4 mb6-xs">
              <h6 class="mb1">Kungsholmen</h6>
              <ul class="footer-links contact-info">
                <li><i class="fas fa-map-marker-alt"></i>Franzéngatan 18, 112 17<br>Stockholm</li>
            ...
            <div class="col-md-4 mb6-xs">
              <h6 class="mb1">Specialistkliniken</h6>
              <ul class="footer-links contact-info">
                <li><i class="fas fa-map-marker-alt"></i>Franzéngatan 67, 112 15<br>Stockholm</li>
            ...
            <div class="col-md-4 mb6-xs">
              <h6 class="mb1">Degerfors</h6>
              <ul class="footer-links contact-info">
                <li><i class="fas fa-map-marker-alt"></i>Medborgargatan 17, 693 30<br>Degerfors</li>
        ...
        <div class="col-md-3 footer-right mb6-xs">
          <h6 class="mb1">Behandlingar</h6>
          <ul class="footer-links">
            <li><a href="fyllningar.php">Fyllningar</a></li>
